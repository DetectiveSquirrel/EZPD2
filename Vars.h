...
VAR(DWORD, NormalMonsterMarkerStyle)
VAR(DWORD, NormalMonsterMarkerFontSize)
VAR(DWORD, MinionMonsterMarkerStyle)
VAR(DWORD, MinionMonsterMarkerFontSize)
VAR(DWORD, ChampionMonsterMarkerStyle)
VAR(DWORD, ChampionMonsterMarkerFontSize)
VAR(DWORD, BossMonsterMarkerStyle)
VAR(DWORD, BossMonsterMarkerFontSize)
VAR(DWORD, ImportantMonsterMarkerStyle)
VAR(DWORD, ImportantMonsterMarkerFontSize)
VAR(DWORD, ActualBossMonsterMarkerStyle)
VAR(DWORD, ActualBossMonsterMarkerFontSize)
